    ...
    async getHtml() {
        ...
        <div id="home" class="grid grid-rows-2 grid-cols-6">
          ...
          <div class="showcase-text mt-10 xs:mt-0">
             ...
             <div class="sub-heading mt-2 mb-4 text-xl sm:text-xl tracking-tight drop-shadow-lg">Men's 10-week Spring Comp<br>
 Starting 24th September through to 26th November <br><br>
Junior Summer Comps Registrations Now Open
</div>
