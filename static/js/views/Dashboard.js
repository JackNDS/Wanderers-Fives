    ...
    async getHtml() {
        ...
        <div id="home" class="grid grid-rows-2 grid-cols-6">
          ...
          <div class="showcase-text mt-10 xs:mt-0">
             ...
             <div class="sub-heading mt-2 mb-4 text-md sm:text-lg tracking-tight drop-shadow-lg">Adults Summer Comp kicks off on Monday 2nd February! <br><br> Special Junior School Holiday Competition kicks off on Thursday 8th January running for four weeks at special price of $250 per team!</div>
