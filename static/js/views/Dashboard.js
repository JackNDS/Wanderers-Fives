    ...
    async getHtml() {
        ...
        <div id="home" class="grid grid-rows-2 grid-cols-6">
          ...
          <div class="showcase-text mt-10 xs:mt-0">
              ...
              <div class="sub-heading mt-2 mb-4 text-xl sm:text-4xl tracking-tight drop-shadow-lg">Spring Competition kicks off 17th October for Adults and 7th November for Junior Leagues</div>
