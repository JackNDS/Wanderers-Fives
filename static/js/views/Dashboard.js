    ...
    async getHtml() {
        ...
        <div id="home" class="grid grid-rows-2 grid-cols-6">
          ...
          <div class="showcase-text mt-10 xs:mt-0">
              ...
              <div class="sub-heading mt-2 mb-4 text-xl sm:text-4xl tracking-tight drop-shadow-lg">Winter Competition kicks off April 15th</div>
              <a href="fives-portal"><button class="btn -ml-1 shadow-lg rounded-full py-2 sm:py-4 px-6 hover:translate-y-1 transition-transform duration-500 ease-in-out text-2xl tracking-wide"">Join a League</button></a>
          </div>
