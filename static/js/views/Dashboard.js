    ...
    async getHtml() {
        ...
        <div id="home" class="grid grid-rows-2 grid-cols-6">
          ...
          <div class="showcase-text mt-10 xs:mt-0">
             ...
             <div class="sub-heading mt-2 mb-4 text-xl sm:text-xl tracking-tight drop-shadow-lg">Wanderers Fives World Cup begins June 28th!</div>
          ...
          <div target="popup" href="wanderers.intrac.com.au/dashboard?page=team&tab=fixtures_results" onclick="window.open('wanderers.intrac.com.au/dashboard?page=team&tab=fixtures_results','popup','width=500,height=800,left=400,top=100'); return false;" class="flex clickable-container default items-end hire col-span-6 md:col-span-2 p-10 border-solid border-gray-200 border-t-2 border-b-2 border-l-0 text-white" id="parties">
          <a target="popup" href="wanderers.intrac.com.au/dashboard?page=team&tab=fixtures_results?" onclick="window.open('wanderers.intrac.com.au/dashboard?page=team&tab=fixtures_results?','popup','width=500,height=800,left=400,top=100'); return false;">
