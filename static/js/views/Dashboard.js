    ...
    async getHtml() {
        ...
        <div id="home" class="grid grid-rows-2 grid-cols-6">
          ...
          <div class="showcase-text mt-10 xs:mt-0">
             ...
             <div class="sub-heading mt-2 mb-4 text-lg sm:text-lg tracking-tight drop-shadow-lg">Autumn Comps to begin week commencing the 11th May</div>
              <a href="/contact"><button class="btn -ml-1 shadow-lg rounded-full py-2 sm:py-4 px-6 hover:translate-y-1 transition-transform duration-500 ease-in-out text-2xl tracking-wide"">Enquire Now</button></a>
          </div>
