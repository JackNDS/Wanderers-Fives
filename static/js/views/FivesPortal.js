...
export default class extends AbstractView {
    ...
    <div class="explore-container">
        ...
        <div class="text-white px-7 text-lg">The Wanderers Fives World Cup presented by Western Sydney International Airport will be a free social mixed tournament held on Sunday evenings from June 29 - July 19, football, food trucks and plenty of fun to be had for the whole family!</div>
        <div class="explore">
